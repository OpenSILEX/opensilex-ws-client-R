...
```{r,echo=TRUE,message=FALSE, warning=FALSE}
  ...
  # connectToOpenSILEXWS(username="guest@opensilex.org",password="guest", url = "http://www.opensilex.org/rest/")
```
...
```{r,echo=TRUE,message=FALSE, warning=FALSE}
  ...
  # connectToOpenSILEXWS(username="guest@opensilex.org",password="guest", url = "www.opensilex.org/rest/")
```
